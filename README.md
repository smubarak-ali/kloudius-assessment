This is a new [**React Native**](https://reactnative.dev) project for assessment, bootstrapped using [`@react-native-community/cli`](https://github.com/react-native-community/cli).
